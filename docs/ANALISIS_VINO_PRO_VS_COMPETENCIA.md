...
| **Sumiller IA** | Preguntas en lenguaje natural, maridajes, recomendaciones por tipo/país/precio; contexto conversacional ("y de esos el más barato"); recomendaciones personalizadas; feedback me gusta/no me gusta | ✅ |
| **Sumiller voz** | Reconocimiento de voz en el front; opción IA local (agente 8080) para PRO | ✅ |
...
| **Dashboard** | Analytics: búsquedas, escaneos, preguntas sumiller; tendencias; por país; preguntas frecuentes | ✅ |
...
| IA (CellarChat) | ✅ Elegir qué beber, maridaje, análisis de bodega | ✅ Sumiller conversacional + recomendaciones |
...
|---------------|--------|----------------|---------------|------------------|
| Escaneo etiqueta | ✅ | ✅ | ✅ | ✅ |
| Sumiller / IA conversacional | Limitado | CellarChat | No | ✅ **Fuerte** |
...
4. **Múltiples modos del sumiller (Nube vs IA local 8080)**  
...
- **Sumiller IA** con contexto, maridaje por cocina, recomendaciones por sesión y feedback.
...
**Nos falta sobre todo comunidad (valoraciones, reseñas, seguir usuarios y feed); nos sobra sobre todo “énfasis” en cosas que el usuario final no ve (dashboard) o que son muy de nicho (adaptador/PDF si no hay uso). Nuestro núcleo fuerte es el sumiller IA + maridaje + guías locales + cobertura global; el siguiente paso con más impacto es añadir valoraciones y wishlist y, cuando tenga sentido, feed social y app nativa.**
